...
> Рекомендации по процессу заполнения документа (workflow) - [здесь](https://www.youtube.com/watch?v=PW9TGNr1Vqk).  
> Детальный доклад о том, что такое ML System Design Doc и о том, как, когда и зачем его составлять - [тут](https://www.youtube.com/watch?v=EW885gIlz3A).
...
> **Важно:** Если блок-схема шаблонна - т.е. её можно скопировать и применить к разным продуктам, то она некорректна. Блок-схема должна показывать схему решения для конкретной задачи, поставленной в части 1.
...
> **Важно:** Если описание в дизайн доке шаблонно - т.е. его можно скопировать и применить к разным продуктам, то оно некорректно. Дизайн док должен показывать схему решения для конкретной задачи, поставленной в части 1.
...
- [Шаблон ML System Design Doc [EN] от AWS](https://github.com/eugeneyan/ml-design-docs) и статья с объяснением каждого раздела
- [Верхнеуровневый шаблон ML System Design Doc от Google](https://docs.google.com/document/d/1fqo9e5J-5yToG2mTlD1sc0Ob0_0E5fhM0sILFkqxoZk/) и описание общих принципов его заполнения
- [ML Design Template от ML Engineering Interviews](https://www.mlengineer.io/mldesign)
- [Статья Design Documents for ML Models на Medium](https://medium.com/@Shashanksinha_54/design-documents-for-ml-models-bbcd1464bd4c). Верхнеуровневые рекомендации по содержанию дизайн-документа и объяснение, зачем он вообще нужен
- [Краткий Canvas для ML-проекта от Made with ML](https://madewithml.com/). Подходит для верхнеуровневого описания идеи, чтобы понять, имеет ли смысл идти дальше
